<?php
    require ('classes\steamAuthentification.class.php');  
...
<html lang="en">
  <head>
    ...
    <title>steamAuthentification Demo</title>
  ...
  <body style="background-color: #EEE;">
    <div class="container" style="margin-top: 30px; margin-bottom: 30px; padding-bottom: 10px; background-color: #FFF;">
		<h1>steamAuthentification Demo</h1>
		<span class="small pull-left" style="padding-right: 10px;">for steamAuthentification 1.0</span>
		<hr>
		<?php
if(!$steam->loggedIn()) {
    ...
    echo "<div style='float:left;'><a href='https://github.com/blackcetha/steamAuthentification'><button type='button' class='btn btn-success' style='margin: 2px 3px;'>GitHub Repo</button></a><a href='https://github.com/blackcetha/steamAuthentification/releases'><button type='button' style='margin: 2px 3px;' class='btn btn-warning'>Download</button></a></div><br><br>
	...
	<a href="https://github.com/blackcetha/steamAuthentification">GitHub Repo</a><br>
